...
export default function SidebarMenu() {
  ...
  return (
    <div className="sidebar-menu-dashboard custom-sidebar-bg">
      <style>{`
        .custom-sidebar-bg{
          background: #ffffff;
        }
      ...
      <div className="menu-box">
        ...
        <ul className="box-menu-dashboard custom-ul-bar">
          <li
          ...
          <li
            className={`nav-menu-item ${pathname == "/my-favourites" ? "active" : ""
              }`}
          >
            <Link className="nav-menu-link" to={`/my-favourites`}>
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
          ...
          <li
            className={`nav-menu-item ${pathname == "/my-requests" ? "active" : ""
              }`}
          >
            <Link className="nav-menu-link" to={`/my-requests`}>
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
