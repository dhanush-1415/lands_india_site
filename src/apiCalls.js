...
//       formData.append(`PropertiesInput[${index}][inputId]`, item.input_id);
//       formData.append(`PropertiesInput[${index}][value]`, item.input_value);
//     });
//   }
...
export const getSellerProperties = async (id) => {
  ...
  const url = `${baseUrl}/legalAdviser/${id}`;
...
export const getEventsList = async () => {
  ...
  const url = `${baseUrl}/event/get-event`;
